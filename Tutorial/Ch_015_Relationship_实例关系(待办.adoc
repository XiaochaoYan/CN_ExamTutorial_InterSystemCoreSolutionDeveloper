...
其中 Cardinality 指连接关系中这个 类Class 所在关系中对应的角色，如 1ToN 关系中就分 One / Many 两个角色，下方例子，当前对应的是 Many 部分。只有 one/many/parent/children 这几种已经被定义好的可选 +

其中 Inverse 指连接关系中的对方的类对应的 【Relationship Name 关系名】，所以此处应为 Employee +
...
==== 对应当前类的参数有 1.Relationship Name 2.Cardinality +
==== 对应对方类的参数有 1.classname 2. inverse +
