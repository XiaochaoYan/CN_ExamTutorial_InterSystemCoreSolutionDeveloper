...
*另外* 除了 Relationship 需要定义外， 目录Index 也是需要在两个类中事先定义的。 +
https://docs.intersystems.com/iris20212/csp/docbook/DocBook.UI.Page.cls?KEY=ROBJ_classdef_index[EN_Index 关键字定义] +
